<template>
	<label class="check-box" @click="click"  @dblclick="dblclick">
		<input type="checkbox" :id="key" :value="checkBoxData.checked">
		<div class="check-box__marker">
		...
		<div class="check-box__text">{{checkBoxData.text}}</div>
	</label>
</template>
<script>
	export default
