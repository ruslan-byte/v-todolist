...
<script>
	...
	import vToDoList from "@/components/v-TodoList"
	import { ref } from "vue"
	export default{
		name:"v-todo",
			...
			let todoData = ref([
				...
				},
				{
					...
					checkBoxes: [
						...
						{index:8,taskText: 'Incididunt adipisicing aliquip et incididunt tempor duis anim cupidatat eu do velit nisi magna.', isChecked: false,},
					]
				},
			])
